  ...
  try {
    ...
    const plan = buildExportPlan({
      scope: {
        ...
        regionName: body?.scope?.regionName ? String(body.scope.regionName) : undefined,
        regionSnapshot: body?.scope?.regionSnapshot ? String(body.scope.regionSnapshot) : undefined,
        legalCodes: Array.isArray(body?.scope?.legalCodes) ? body.scope.legalCodes.map(String) : undefined,
